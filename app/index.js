  ...
  render: function(){
    ...
    var circles = this.state.friends.map(function(circle, index) {
      if (circle.id !== self.state.id) {
        return React.createElement(Circle, {id: circle.id, className: "guest", fill: "#d7d7d7", position: circle.position})
      }
    });
    return React.createElement("svg", {id: "main-stage", 
      height: this.state.height, 
      width: this.state.width, 
      onMouseMove: this.handleMouseMove, 
      onTouchMove: this.handleMouseMove}, 
        circles, 
        React.createElement(Circle, {id: this.state.id, className: "current-user", fill: "#1a1a1a", position: this.state.position})
    )
  }

});

React.render( React.createElement(Stage, null), document.getElementById('example') );

module.exports = Stage;

},{"node-uuid":3,"react":149,"reactfire":150}],2:[function(require,module,exports){
